...
/* harmony import */ var _modules_arrlists_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
/* harmony import */ var _modules_localStorage_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);





document.addEventListener('DOMContentLoaded', _modules_layout_js__WEBPACK_IMPORTED_MODULE_1__["default"].displayToDo);
...
document.querySelector('form').addEventListener('submit', (e) => {
  e.preventDefault();
  const todoL = _modules_localStorage_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLists();
  const toDoInput = document.getElementById('todo-input').value;
  const id = todoL.length + 1;
  const completed = false;

  const todo = new _modules_arrlists_js__WEBPACK_IMPORTED_MODULE_2__["default"](toDoInput, id, completed);

  _modules_layout_js__WEBPACK_IMPORTED_MODULE_1__["default"].addLList(todo);

  _modules_localStorage_js__WEBPACK_IMPORTED_MODULE_3__["default"].addTodo(todo);

  _modules_layout_js__WEBPACK_IMPORTED_MODULE_1__["default"].clearField();
});
...
document.getElementById('to-do-container').addEventListener('click', (e) => {
  ...
  _modules_layout_js__WEBPACK_IMPORTED_MODULE_1__["default"].deleteTodo(e.target);
  if (e.target.classList.contains('check')) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _localStorage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);


class Lists {
  static displayToDo() {
    const todo = _localStorage_js__WEBPACK_IMPORTED_MODULE_0__["default"].getLists();
